...
{
    public class choopersguidelocationScrapper : IScrapper
    {
        ...
        {
            return "http://choopersguide.com/find-addiction-treatment/location/united-states-addiction-treatment";
        }
        ...
        public void ExtractData()
        {
            ...
            GenrateReport.StartGenerate("choopersguide_location", modelData);
        }
